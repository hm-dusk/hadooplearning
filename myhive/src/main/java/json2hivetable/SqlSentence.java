...
/**
 * @author liming
 * @date Created in 2018/9/29 9:24
 */
public class SqlSentence {
	...
	public static String JSON_OBJECT = "com.alibaba.fastjson.JSONObject";
	public static String JSON_ARRAY = "com.alibaba.fastjson.JSONArray";
